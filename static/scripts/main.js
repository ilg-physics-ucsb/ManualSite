...
function htmltweaks() {
  ...
  RefList = { Eq: ['Equation'], Qu: ['Question'], Fi: ['Fig'], Si: ['Simulation'], Ex: ['Exercise'], Vi: ["Video"]}
...
function replace_tags() {
  var text = document.querySelectorAll('#mdcontent h3, #mdcontent h2, #mdcontent p, #mdcontent li, #mdcontent ol, #mdcontent ol li, #mdcontent ul,  .Table td') 
